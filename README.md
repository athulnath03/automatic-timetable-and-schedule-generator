...
GEN["GeneratePage\nCollect inputs:\n- days, periods\n- classes\n- subjects[{name,teacher,periods_per_week}]"]:::frontend
...
API_ROUTES_DEV -->|"calls generate() with parsed JSON"| SCHED_DEV
SCHED_DEV -->|"returns timetable structure"| API_ROUTES_DEV
API_ROUTES_DEV -->|"HTTP 200 JSON\n{timetable: ...}"| GEN
...
%% Dev backend wiring to source modules
...
%% Prod: Flask serves SPA + API on same origin
PROD_BROWSER -->|"HTTP GET / and /assets/*\n:5000"| STATIC_SERVE
...
SCHED_PROD -->|"returns timetable structure"| API_ROUTES_PROD
...
API_ROUTES_PROD -->|"defined in"| APP_PY
SCHED_PROD -->|"implemented in"| SCHED_PY

%% Saved feature (assumption only)
SAVED -->|"read/write (if implemented)"| BSTORE
BSTORE -.->|"optional\nnot verified"| SAVED

%% =========================================================
%% Click Events (from component_mapping)
%% =========================================================
click APP_PY "https://github.com/athulnath03/automatic-timetable-and-schedule-generator/blob/main/backend/app.py"
click SCHED_PY "https://github.com/athulnath03/automatic-timetable-and-schedule-generator/blob/main/backend/scheduler.py"
click REQS "https://github.com/athulnath03/automatic-timetable-and-schedule-generator/blob/main/backend/requirements.txt"

click SPA_DEV "https://github.com/athulnath03/automatic-timetable-and-schedule-generator/tree/main/frontend/"
click VITE "https://github.com/athulnath03/automatic-timetable-and-schedule-generator/blob/main/frontend/vite.config.js"
click DIST "https://github.com/athulnath03/automatic-timetable-and-schedule-generator/tree/main/frontend/"
click APP "https://github.com/athulnath03/automatic-timetable-and-schedule-generator/blob/main/frontend/src/App.jsx"
click TOPBAR "https://github.com/athulnath03/automatic-timetable-and-schedule-generator/blob/main/frontend/src/components/Topbar.jsx"
click SIDEBAR "https://github.com/athulnath03/automatic-timetable-and-schedule-generator/blob/main/frontend/src/components/Sidebar.jsx"
click HOME "https://github.com/athulnath03/automatic-timetable-and-schedule-generator/blob/main/frontend/src/components/DashboardHome.jsx"
click GEN "https://github.com/athulnath03/automatic-timetable-and-schedule-generator/blob/main/frontend/src/components/GeneratePage.jsx"
click VIEW "https://github.com/athulnath03/automatic-timetable-and-schedule-generator/blob/main/frontend/src/components/TimetableView.jsx"
click SAVED "https://github.com/athulnath03/automatic-timetable-and-schedule-generator/blob/main/frontend/src/components/SavedPage.jsx"
click STATE "https://github.com/athulnath03/automatic-timetable-and-schedule-generator/blob/main/frontend/src/main.jsx"

click STATIC_SERVE "https://github.com/athulnath03/automatic-timetable-and-schedule-generator/blob/main/frontend/index.html"
click DEV_NOTE "https://github.com/athulnath03/automatic-timetable-and-schedule-generator/blob/main/README.md"
click PROD_NOTE "https://github.com/athulnath03/automatic-timetable-and-schedule-generator/blob/main/README.md"

%% Additional mapped files
click BSTORE "https://github.com/athulnath03/automatic-timetable-and-schedule-generator/tree/main/frontend/src/components/"
click API_ROUTES_DEV "https://github.com/athulnath03/automatic-timetable-and-schedule-generator/blob/main/backend/app.py"
click API_ROUTES_PROD "https://github.com/athulnath03/automatic-timetable-and-schedule-generator/blob/main/backend/app.py"
click FLASK_DEV "https://github.com/athulnath03/automatic-timetable-and-schedule-generator/blob/main/backend/app.py"
click FLASK_PROD "https://github.com/athulnath03/automatic-timetable-and-schedule-generator/blob/main/backend/app.py"

%% Optional artifacts mentioned
click DEV_BROWSER "https://github.com/athulnath03/automatic-timetable-and-schedule-generator/tree/main/timetable"
click PROD_BROWSER "https://github.com/athulnath03/automatic-timetable-and-schedule-generator/tree/main/stop_timetable"
...
%% package metadata
click DEV_NOTE "https://github.com/athulnath03/automatic-timetable-and-schedule-generator/blob/main/frontend/package.json"
click PROD_NOTE "https://github.com/athulnath03/automatic-timetable-and-schedule-generator/blob/main/frontend/package-lock.json"

%% styles
click VIEW "https://github.com/athulnath03/automatic-timetable-and-schedule-generator/blob/main/frontend/src/styles.css"
